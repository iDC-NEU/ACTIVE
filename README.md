...
Supports efficient build, search, and streaming update operations.
The full version of the paper is available [here](https://github.com/iDC-NEU/ACTIVE/blob/main/ACTIVE-FULL.pdf).
